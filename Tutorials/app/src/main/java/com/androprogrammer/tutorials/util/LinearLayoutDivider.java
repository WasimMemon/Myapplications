...
public class LinearLayoutDivider extends RecyclerView.ItemDecoration {
    ...
    public LinearLayoutDivider(Context context, AttributeSet attrs, boolean showFirstDivider,
    ...
    public LinearLayoutDivider(Context context, int resId) {
        mDivider = context.getResources().getDrawable(resId);
    }

    public LinearLayoutDivider(Context context, int resId, boolean showFirstDivider,
                                 boolean showLastDivider) {
        this(context, resId);
        mShowFirstDivider = showFirstDivider;
        mShowLastDivider = showLastDivider;
    ...
    public LinearLayoutDivider(Drawable divider, boolean showFirstDivider,
                                 boolean showLastDivider) {
        this(divider);
        mShowFirstDivider = showFirstDivider;
        mShowLastDivider = showLastDivider;
